      ...
      {nftData ? (
        <div className="flex gap-10 mx-20 mt-8 flex-col-2">
          ...
          <div className="flex flex-col w-2/3">
            <div className="mb-2 font-sans text-4xl font-bold">{nftData.name}</div>
                    ...
                    return (
                      <div className="flex h-16 text-center border border-gray-200 rounded-md" key={i.value}>
                        <div className="m-auto">
                          <p className="text-sm font-bold text-gray-500 uppercase">{i.name}</p>
                          <p className="w-32 text-xs font-semibold text-gray-500 truncate">{i.value}</p>
                        </div>
                      </div>
                    )
                  })}
